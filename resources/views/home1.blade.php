                            ...
                            <ul class="docListWindow small-slimscroll-style">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/prof/prof1.jpg" alt="" width="40"
                                             height="40">
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/prof/prof2.jpg" alt="" width="40"
                                             height="40">
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/prof/prof3.jpg" alt="" width="40"
                                             height="40">
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/prof/prof4.jpg" alt="" width="40"
                                             height="40">
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/prof/prof5.jpg" alt="" width="40"
                                             height="40">
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/prof/prof6.jpg" alt="" width="40"
                                             height="40">
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="patient-img sorting_1">
                                                <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/std/std6.jpg" alt="">
                                            </td>
                                            <td>John Deo</td>
                                            <td>05-01-2017</td>
                                        ...
                                        <tr>
                                            <td class="patient-img sorting_1">
                                                <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/std/std4.jpg" alt="">
                                            </td>
                                            <td>Eugine Turner</td>
                                            <td>04-01-2017</td>
                                        ...
                                        <tr>
                                            <td class="patient-img sorting_1">
                                                <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/std/std2.jpg" alt="">
                                            </td>
                            ...
                            <div class="mdl-tabs__panel p-t-20" id="tab5-panel">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="patient-img sorting_1">
                                                <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/std/std1.jpg" alt="">
                                            </td>
                                            <td>Eugine Turner</td>
                                            <td>04-01-2017</td>
                                            <td><span class="label label-success">Paid</span></td>
                                        ...
                                        <tr>
                                            <td class="patient-img sorting_1">
                                                <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/std/std5.jpg" alt="">
                                            </td>
                                            <td>Jayesh Parmar</td>
                                            <td>03-01-2017</td>
                                            <td><span class="label label-danger">Unpaid</span></td>
                            ...
                            <div class="mdl-tabs__panel p-t-20" id="tab6-panel">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="patient-img sorting_1">
                                                <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/std/std8.jpg" alt="">
                                            </td>
                                            <td>Jane Elliott</td>
                                            <td>06-01-2017</td>
                                        ...
                                        <tr>
                                            <td class="patient-img sorting_1">
                                                <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/std/std7.jpg" alt="">
                                            </td>
                                            <td>Jacqueline Howell</td>
                                            <td>03-01-2017</td>
                                            <td><span class="label label-warning">Pending</span></td>
                                        ...
                                        <tr>
                                            <td class="patient-img sorting_1">
                                                <img src="http://radixtouch.in/templates/admin/smart/source/assets/img/std/std9.jpg" alt="">
                                            </td>
                                            <td>Jacqueline Howell</td>
                                            <td>03-01-2017</td>
                                            <td><span class="label label-primary">Paid</span></td>
