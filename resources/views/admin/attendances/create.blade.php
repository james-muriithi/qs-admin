    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.attendances.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('employeeid') ? 'is-invalid' : '' }}" name="employeeid_id" id="employeeid_id">
                    @foreach($employeeids as $id => $entry)
                        <option value="{{ $id }}" {{ old('employeeid_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_in') ? 'is-invalid' : '' }}" type="text" name="time_in" id="time_in" value="{{ old('time_in') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_out') ? 'is-invalid' : '' }}" type="text" name="time_out" id="time_out" value="{{ old('time_out') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('area_info') ? 'is-invalid' : '' }}" type="text" name="area_info" id="area_info" value="{{ old('area_info', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hours_in') ? 'is-invalid' : '' }}" type="text" name="hours_in" id="hours_in" value="{{ old('hours_in', '') }}">
