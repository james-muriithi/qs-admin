    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left d-none d-md-flex">
                    <div class="page-title">{{ trans('cruds.businessAccount.title_singular') }} {{ trans('global.edit') }}</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li>
                        <i class="fa fa-home"></i>&nbsp;
                        <a class="parent-item" href="{{route('admin.business-accounts.show', $businessAccount->id)}}">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <form method="POST" id="myForm" action="{{ route("admin.business-accounts.update", [$businessAccount->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body row">
                            <div class="col-lg-6 p-t-20">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('BS_ID') ? 'is-invalid' : '' }}" type="text" name="BS_ID" id="bsid" value="{{ old('BS_ID', $businessAccount->BS_ID) }}" readonly>
                                    @if($errors->has('BS_ID'))
