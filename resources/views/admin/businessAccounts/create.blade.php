...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.businessAccount.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.business-accounts.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="bsid">{{ trans('cruds.businessAccount.fields.bsid') }}</label>
                <input class="form-control {{ $errors->has('bsid') ? 'is-invalid' : '' }}" type="text" name="bsid" id="bsid" value="{{ old('bsid', '') }}" required>
                @if($errors->has('bsid'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bs_logo') ? 'is-invalid' : '' }}" type="text" name="bs_logo" id="bs_logo" value="{{ old('bs_logo', '') }}">
