    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">{{ trans('cruds.permission.title_singular') }} {{ trans('global.edit') }}</div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <form method="POST" id="myForm" action="{{ route("admin.permissions.update", [$permission->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
